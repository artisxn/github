...
class GitHubFactory
{
     ...
     *
     * @var \codicastudio\GitHub\Auth\AuthenticatorFactory
     */
    protected $auth;
     ...
     *
     * @var \codicastudio\GitHub\Cache\ConnectionFactory
     */
    protected $cache;
     ...
     *
     * @param \codicastudio\GitHub\Auth\AuthenticatorFactory $auth
     * @param \codicastudio\GitHub\Cache\ConnectionFactory   $cache
     *
     * @return void
     */
     ...
     * @param string[] $config
     *
     * @return \codicastudio\GitHub\Http\ClientBuilder
     */
